...
/**
 * Autonomous variant that spins the launcher to a target RPM, then feeds using the indexer and fuel agitator.
 * This command runs until interrupted. Behavior matches SpinUpAndFeedCommand but provided under a distinct class
 * name for clarity in autonomous sequences.
 */
public class AutoSpinUpAndFeedCommand extends Command {
    ...
    public AutoSpinUpAndFeedCommand(
